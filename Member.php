...
class Member
{
    ...
    public function startLiveProcess(){
        $query = 'INSERT INTO tbl_user (username, telephone,email,package) VALUES (?,?,?,?)';
            $paramType = 'ssss';
            $paramValue = array(
                $_POST["username"],
                $_POST["telephone"],
            ...
            if (isset($userId)) {
                $response = array(
                    "status" => "success",
                    "message" => "You have registered successfully.Await instructions in your email"
                );
            }
